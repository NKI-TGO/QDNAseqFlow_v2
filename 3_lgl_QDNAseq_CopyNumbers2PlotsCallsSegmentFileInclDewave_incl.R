...
if(dewaving == 'yes') {
  ...
  if(binSize == 50) {NormalCalibrationSet_ofcurrentBinSize = NormalCalibrationSet_50kb}
  ...
  if(!binSize %in% c(15, 30, 50, 100, 1000)) {stop("Your binSize is not one of 15kb, 30kb, 50kb, 100kb or 1000kb. Dewaving is currently not possible for other bin sizes.")}
