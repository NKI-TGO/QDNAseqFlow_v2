---
title: "QDNAseq_hg38_IntEnd_Bam2Plots Server"
...
Preselected for 100kb
```{r}
pathToOutputDir <- "/pathto save the files/xxxx_hg38_100kb/"
...
### Dewaving
Here we need to select the one we want use and mute the other
Preselected for 100kb
If you do not want to dewave comment out the entire block
```{r }
library(QDNAseq.dev)
#binSize == 15
...
currentpathToScript <- "path/Notebooks/bash_R_scripts/"
...
source("/path/Notebooks/bash_R_scripts/QDNAseq-observedVariance.R")
#Remove outliers
#Use the whole path
